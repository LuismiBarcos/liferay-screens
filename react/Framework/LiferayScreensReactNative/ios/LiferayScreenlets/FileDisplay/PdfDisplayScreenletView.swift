...
class PdfDisplayScreenletView: RCTView, FileDisplayScreenletDelegate {
  // Variables
  var screenlet: PdfDisplayScreenlet!
  ...
  override init(frame: CGRect) {
    ...
    self.screenlet = PdfDisplayScreenlet(frame: frame, themeName: "default")
