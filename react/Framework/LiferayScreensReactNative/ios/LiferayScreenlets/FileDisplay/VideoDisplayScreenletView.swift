//
//  VideoDisplayScreenletView.swift
...
class VideoDisplayScreenletView: RCTView, FileDisplayScreenletDelegate {
  // Variables
  var screenlet: VideoDisplayScreenlet!
  ...
  override init(frame: CGRect) {
    ...
    self.screenlet = VideoDisplayScreenlet(frame: frame, themeName: "default")
